...
def get_chores():
    ...
    for chore in chores:
        result.append({
            ...
            'assignedUsers': [{'name': u.email.split('@')[0]} for u in chore.assignments],
...
"""
## New code that is updated and onl yhas one bug that I will fix in the next sprint. DO NOT UNCOMMENT CODE ABOVE THIS POINT JUST YET.
